...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :metadata=
    s.metadata = { 'bug_tracker_uri' => 'https://github.com/minitest/minitest/issues',
                   'changelog_uri' => 'https://github.com/minitest/minitest/blob/master/History.rdoc', 'homepage_uri' => 'https://github.com/minitest/minitest' }
  end
  s.require_paths = ['lib']
  ...
  s.add_development_dependency('hoe', ['~> 4.2'])
