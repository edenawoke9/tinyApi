...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :metadata=
    s.metadata = { 'bug_tracker_uri' => 'https://github.com/rspec/rspec/issues',
  ...
  s.require_paths = ['lib']
  s.authors = ['David Chelimsky', 'Myron Marson', 'Jon Rowe', 'Sam Phippen',
  ...
  s.summary = 'rspec-support-3.13.4'
